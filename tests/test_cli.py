...
def test_full_many_processes_directory(
    ...
    assert html_outputs == [
        "sample/2025-01-01-03-03/Sample_Person_CV.html",
        "sample/2025-01-01-04-04/Sample_Person_CV.html",
    ]
    assert pdf_outputs == [
        "sample/2025-01-01-03-03/Sample_Person_CV.pdf",
        "sample/2025-01-01-04-04/Sample_Person_CV.pdf",
    ]
